...
```{r Venn diagram up, include=TRUE, fig.cap="Venn diagram of up-regulated TRA genes", fig.height=3, fig.width=4.5, fig.align="center"}
...
```{r Tissue distribution plot of tra.data, include=TRUE, fig.cap="TRA tissue distribution in original TRA data", fig.height=3.2, fig.width=7, fig.align="center"}
