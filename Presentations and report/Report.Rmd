...
# Generate a data frame containing both k and total within-cluster sum of square
elbow_df <- data.frame(
  k = 1:10 ,
...
annotation of the limma table (complete) with emsembl information
```{r}
...
#5 genes are continuously up-regulated from 1-cell stage to blastocyst stage
...
### 3.5 chemokine extraction

```{r}
#extract chemokine genes that are TRAs
...
#no TRA chemokines found in limma tables
#looking for non-TRA chemokines in limma tables
...
#"CCR3" Down-regulated  "CXCL14" Up-regulated
