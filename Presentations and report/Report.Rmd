...
```{r Tissue distribution plot,include=TRUE, fig.cap="Tissue distribution plot", fig.height=3.2, fig.width=7, fig.align='center'}
...
par(mar=c(5,9,4,1)+.1)
barplot(height = as.numeric(tissue.distribution.arranged$tissue.number[1:10]),names.arg = tissue.distribution.arranged$max.tissue[1:10],cex.names=0.54,col=rainbow(10), main="Frequency of TRA DEGs between 1-cell stage and 8-cell stage", cex.main= 0.9, xlab="Frequency",las=2, horiz= TRUE, cex.lab=1, cex.axis= 1)
