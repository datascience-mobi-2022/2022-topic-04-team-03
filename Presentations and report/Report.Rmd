...
## 4.3 Chemokines
According to our hypothesis, we also examined the expression of chemokines. The result of filtering of our annotated TRA matrix showed that there are 62 proteins with a chemokine motif. Due to this, we looked at whether some of the filtered proteins are DEGs in our four clusters. The result of this was that there are no proteins with a chemokine motif that are TRAs and DEGs. 
...
+ Between the stages 1-cell to 8-cell CXCL14 was up-regulated with a log fold change (logFC) of approximately 1 and the chemokine receptor CCR3 was down-regulated (logFC= -1.12). 
