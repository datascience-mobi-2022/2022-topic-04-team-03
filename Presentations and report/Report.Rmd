...
setwd("~//Documents//GitHub//2022-topic-04-team-03//Quality-Control//Plots//Scatterplott"))
expression.data <- exprs(human.vsnrma)
...
barplot(height = as.numeric(tissue.distribution.arranged$tissue.number[1:10]),names.arg = tissue.distribution.arranged$max.tissue[1:10],cex.names=0.5,col=rainbow(10), main="Frequency of TRAs in our data", xlab="Frequency",las=2, horiz= TRUE, cex.lab=0.5, cex.axis= 0.5, beside= TRUE)
...
View(annotated.tra[rownames(annotated.tra) %in% intersect.tra.genes.up,])
...
View(annotated.tra[rownames(annotated.tra) %in% intersect.tra.genes.down,])
```
